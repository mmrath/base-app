...
import com.mmrath.sapp.repository.core.PersistentTokenRepository;
...
public class CustomPersistentRememberMeServices extends
    ...
    @Autowired
    public CustomPersistentRememberMeServices(ApplicationProperties jHipsterProperties, org.springframework.security.core.userdetails
    ...
    protected UserDetails processAutoLoginCookie(String[] cookieTokens, HttpServletRequest request,
        ...
        token.setTokenDate(ZonedDateTime.now());
    ...
    protected void onLoginSuccess(HttpServletRequest request, HttpServletResponse response, Authentication
        ...
        PersistentToken token = userRepository.findOneByUsername(login).map(u -> {
            ...
            t.setTokenDate(ZonedDateTime.now());
    ...
    private PersistentToken getPersistentToken(String[] cookieTokens) {
        ...
        if (token.getTokenDate().plusDays(TOKEN_VALIDITY_DAYS).isBefore(ZonedDateTime.now())) {
            persistentTokenRepository.delete(token);
